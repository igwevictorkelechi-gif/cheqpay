 ...
 *
 * Lives in components/ rather than in a route because it is rendered from TWO
 * places: `/` (the canonical home, where it is what search engines index) and
 * `/welcome` (kept alive for existing links, canonicalised to `/`).
 *
...
function Logo() {
  return (
    <Link href="/" aria-label="CheqPay home" className="shrink-0">
...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-surface text-ink">
      {/* Structured data. Inlined here rather than in a layout because this
          component is what both "/" and "/welcome" render, and it has to be in
          the prerendered HTML to be seen at crawl time. */}
      <script
